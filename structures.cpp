...
size_t PositionHasher::operator() (const Position& pos) const {
    constexpr size_t PRIME_NUM = 37;
    size_t i1 = static_cast<size_t>(pos.row);
    size_t i2 = static_cast<size_t>(pos.col);
    return i1 + i2 * PRIME_NUM;
};
...
std::string_view FormulaError::ToString() const {
    static const std::string error_value{ "#VALUE!" };
    static const std::string error_ref{ "#REF!" };
    static const std::string error_arithm{ "#ARITHM!" };
